...
**CLOSED_WON** — сделка завершена.

**CLOSED_LOST** — отказ с обязательным выбором причины:

* *Недозвон более 3 раз, Уже обновил девайс, Недоверие к компании, Просит удалить из базы, Не прошел скоринг.*
